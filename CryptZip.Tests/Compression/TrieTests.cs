...
namespace CryptZip.Tests
{
    ...
    public class TrieTests
    {
        ...
        public void IndexOf_AddsOneSymbolElements_Added()
        {
            ...
            trie.Add(1);
            trie.Add(2);
            Assert.AreEqual(1, trie.FindChild(0).Index);
            Assert.AreEqual(2, trie.FindChild(1).Index);
            Assert.AreEqual(3, trie.FindChild(2).Index);
        }
        ...
        public void IndexOf_AddsTwoSymbolsElements_Added()
        {
            ...
            TrieNode zeroNode = trie.FindChild(0);
            trie.Add(zeroNode, 0);
            Assert.AreEqual(4, trie.FindChild(zeroNode, 0).Index);

            TrieNode oneNode = trie.FindChild(1);
            trie.Add(oneNode, 1);
            Assert.AreEqual(5, trie.FindChild(oneNode, 1).Index);

            TrieNode twoNode = trie.FindChild(2);
            trie.Add(twoNode, 2);
